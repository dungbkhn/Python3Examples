...
class SpinnerWindow(Gtk.Window):
    def __init__(self, *args, **kwargs):
        ...
        mainBox.pack_start(self.spinner, True, True, 2)

        self.label = Gtk.Label()
        mainBox.pack_start(self.label, False, False, 20)
        ...
        self.label2 = Gtk.Label(label="User")
        ...
        mainBox.pack_start(self.pBox, False, False, 20)

        self.buttonStart = Gtk.Button(label="Start timer")
        self.buttonStart.connect("clicked", self.on_buttonStart_clicked)
        mainBox.pack_start(self.buttonStart, False, False, 0)
        ...
        mainBox.pack_start(self.buttonStop, False, False, 0)
